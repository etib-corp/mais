# Mais Technical Choices

## Language

Mais is written in C++20 to keep the engine portable while still giving direct
...
Mais is configured by the workspace root CMake project. The engine is compiled
